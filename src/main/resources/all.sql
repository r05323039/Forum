...
VALUES (1, 'cho199001@yahoo.com.tw', '秋成勳', 'cho123456', '土城金城路三段208號', '0933123123', '邱爸爸0933999888',
        '1990-01-27', '阿勳'),
       (2, 'fang790328@gmail.com', '方大同', 'fang123456', '林口文化三路二段239號', '0937881356', '方爸爸0933999888',
        '1992-04-01', '國字臉'),
       (3, 'lirock00001@gmail.com', '李石端', 'li123456', '桃園蘆竹奉化路69號', '0939200359', '李爸爸0933999888',
        '1986-12-26', '馮迪索'),
       (4, 'pigting8787@yahoo.com.tw', '朱廷廷', 'pig123456', '台北復興南路二段168號', '0928346510', '朱太太0933999888',
        '1999-05-20', '公子哥'),
       (5, 'garylin8888@gmail.com', '林蓋瑞', 'lin123456', '台北仁愛路四段268號', '0937093487', '林老師0933999888',
        '2003-07-16', '爪哇哥');
...
VALUES ('張哲瑋', 'eliteadmin101', 'elite105105', '系統管理員'),
...
values ('尊爵房', 5000, '<p>后樂大VIP房 / 親子房 / 18坪</p>', '上架'),
...
values (1, '2023-02-13', '2023-02-18', null, null, '維修馬桶', null, 2, '關房單'),
...
insert into `LATEST_NEWS`(`SORT_ID`, `ADMIN_ID`, `NEWS_INTRO`, `ON_NEWS`, `OFF_NEWS`, `POST_TITLE`, `PUBLISHED_TIME`)
values (1, 1, '婦女節', '2023-02-18', '2023-12-31', '歡慶婦女節', '2022-04-22 10:34:23'),
...
insert into `ROOM_VISIT`(`USER_ID`, `USER_NAME`, `PHONE_NUMBER`, `CONTECT_TIME`, `DUE_DATE`, `EMAIL`, `KIDS`,
                         `VISIT_TIME`, `REMARK`)
